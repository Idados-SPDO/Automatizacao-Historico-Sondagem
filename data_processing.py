...
def preenche_status(df_status, workbook, sondagem): 
    ...
    # Verifico se a sondagem em questão é CONSUMIDOR para definir qual será o dicionário de equivalências.
    ...
    for indice, linha in df_status.iterrows():
        ...
        elif sondagem == 'CONSUMIDOR':
            new_row = [data_atual, sondagem, 2045, linha['GRUPO DE STATUS'], linha['QUANTIDADE']]
